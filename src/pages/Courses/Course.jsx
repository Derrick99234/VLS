  ...
  return (
    <>
      <section className="p-3 bg-white relative h-screen flex justify-around">
        ...
        <main className="p-5 w-[78%] rounded-lg relative overflow-y-scroll">
          ...
          <div className="bg-slate-100 h-[180px] rounded-md p-3">
            <div className="flex justify-between p-2 items-center">
              <h2 className=" text-purple-500 font-bold">All course</h2>
            </div>
          ...
          {/* <button
            className="border-2 border-purple-400 w-10 h-10 font-bold rounded-md text-2xl text-blue-400 bg-white fixed bottom-5 right-5"
